...
- <a href="https://react.dev/reference/react/createElement" className="text-(--link) underline underline-offset-4 hover:opacity-80" target="_blank" rel="noopener noreferrer">React without JSX</a> — Deep dive into `createElement`.
- <a href="https://www.typescriptlang.org/docs/handbook/2/narrowing.html#discriminated-unions" className="text-(--link) underline underline-offset-4 hover:opacity-80" target="_blank" rel="noopener noreferrer">TypeScript discriminated unions</a> — The pattern behind the action types.

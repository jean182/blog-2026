...
canonical: "https://loserkid.io/posts/rails-api-react-part-iii"
...
* [Part II: React Frontend Setup](/posts/rails-api-react-part-ii/)
...
Using the gems we added in [Part I](/posts/rails-api-react-part-i/), we can write expressive, one-liner tests in `spec/models/movie_spec.rb`:
